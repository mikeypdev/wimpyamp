...
from .playlist_renderer import PlaylistRendererMixin
from .playlist_input import PlaylistInputMixin
from ..utils.logger import get_logger


class PlaylistWindow(PlaylistInputMixin, PlaylistRendererMixin, QWidget):
    def __init__(
